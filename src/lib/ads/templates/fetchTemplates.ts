...
function getDefaultTemplates(): AdsTemplateRecord[] {
  return [
    ...
    },
    {
      ...
      title: 'Pre-Save Conversions',
      purpose: 'Drive Pre-Save completions for upcoming releases',
      core_signal: 'Pre-Save complete events',
      objective: 'OUTCOME_SALES',
      optimization_goal: 'OFFSITE_CONVERSIONS',
      destination_mode: 'smartlink',
      tracking_events: ['presavecomplete', 'smartlinkclicked'],
      is_active: true,
      sort_order: 5,
    },
    {
      id: 'default-smartlink',
      template_key: 'smartlink_conversions',
      title: 'Smart Link Conversions',
      purpose: 'Drive Smart Link clicks and platform conversions',
      core_signal: 'Smart Link click events',
      objective: 'OUTCOME_SALES',
      optimization_goal: 'OFFSITE_CONVERSIONS',
      destination_mode: 'smartlink',
      tracking_events: [
