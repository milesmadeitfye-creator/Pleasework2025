...
export const handler: Handler = async (event: HandlerEvent, context: HandlerContext) => {
  ...
  try {
    ...
    console.log(`[ads-orchestrate-dryrun] Running dry-run for user ${user.id}`);

    // Create orchestrator config with dryRun=true
    ...
    console.error('[ads-orchestrate-dryrun] Error:', err);
